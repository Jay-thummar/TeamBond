...
public class User {
    ...
    // AI Analysis Data
    private java.util.Map<String, Object> techProfile; // Stores final skills (e.g., {Java=90, React=80})

    @org.springframework.data.mongodb.core.mapping.Field("raw_github_data")
    private Object rawGithubData; // Stores the raw data fetched from MCP for reference
