...
export const clearPrivateKeyCache = () => {
  cachedPrivateKey = null;
  console.log("Private key cache cleared");
};

export const getUserPrivateKey = async () => {
  if (cachedPrivateKey) {
    console.log("Returning cached private key");
  ...
  cachedPrivateKey = decryptedPrivateKey;
  return decryptedPrivateKey;
};

const getContentFromFile = async (baseHandle, fileName) => {
  // Remove try-catch to propagate errors to caller
